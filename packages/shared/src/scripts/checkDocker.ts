...
export const checkDocker = () => {
  ...
  if (!commandExistsSync('docker')) {
    ...
    console.error(
      'Please install Docker by following the official Docker installation instructions:',
    );
  ...
  if (!commandExistsSync('docker-compose')) {
    ...
    console.error(
      'Please install Docker Compose by following the official Docker Compose installation instructions:',
    );
